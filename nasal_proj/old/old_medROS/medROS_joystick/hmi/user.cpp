...
// joystick
int nasal_motion_joystick()
{
       // read joystick
    static int js_rv;
    struct js_event jse; // structure to store joystick's data
    int joystk[10] = {0}; // joystick inputs
    
    js_rv = read_joystick_event(&jse);
    // mapping joystick to command
    switch(jse.type){
    case 1:
      switch(jse.number){
      case 0:break;
      ...
      case 2:
        if(jse.value > 0){
          joystk[0] = 0; joystk[1] = 0; joystk[2] = -1; joystk[3] = 0;
        }
        else{
          joystk[0] = 0; joystk[1] = 0; joystk[2] = 0; joystk[3] = 0;
        }
        break;
      case 3:
        if(jse.value > 0){
          joystk[0] = 0; joystk[1] = -1; joystk[2] = 0; joystk[3] = 0;
        }
        else{
          joystk[0] = 0; joystk[1] = 0; joystk[2] = 0; joystk[3] = 0;
        }
    ...
    case 2:
      ...
      case 4:
        if(jse.value < 0){
          joystk[0] = 0; joystk[1] = 0; joystk[2] = 0; joystk[3] = -1;
        }
        else if(jse.value > 0){
          joystk[0] = 0; joystk[1] = 0; joystk[2] = 0; joystk[3] = 1;
        }
      ...
      case 5:
        if(jse.value < 0){
          joystk[0] = 1; joystk[1] = 0; joystk[2] = 0; joystk[3] = 0;
        }
        else if(jse.value > 0){
          joystk[0] = -1; joystk[1] = 0; joystk[2] = 0; joystk[3] = 0;
        }
